...
@Component
public class StockFinancialIndicatorHandler implements DataTypeHandler {

    private final AKToolsClient aktoolsClient;
    private final FinancialStatementCleanseService cleanseService;

    public StockFinancialIndicatorHandler(AKToolsClient aktoolsClient,
    ...
    public String dataType() {
        return "STOCK_FINANCIAL_INDICATOR";
    }
    ...
    public FetchResult fetch(LocalDate tradeDate) {
        ...
        return FetchResult.single(aktoolsClient.fetchStockFinancialIndicator("603986", startDate, endDate));
    }

    @Override
    public int cleanse(String rawJson, LocalDate tradeDate) {
        return cleanseService.cleanseFinancialIndicator(rawJson);
    }
