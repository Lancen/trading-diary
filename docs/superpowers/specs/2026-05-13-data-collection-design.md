...
|------|------|------|
| id | bigint | PK 自增 |
| data_type | varchar(30) | `STOCK_INFO` / `STOCK_DAILY` / `INDUSTRY` / `CONCEPT` / `MARGIN_STOCK` / `MARGIN_DAILY_SSE` / `MARGIN_DAILY_SZSE` / `TRADE_CALENDAR` |
